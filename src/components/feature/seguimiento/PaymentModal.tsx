...
export default function PaymentModal({ 
  ...
  if (!paymentMethod) {
    return (
      <div className="fixed inset-0 flex items-center justify-center backdrop-blur-sm z-50">
        <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl p-6 max-w-lg w-full mx-4 border border-gray-200">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mb-6 text-lg">
              Total a pagar: <span className="font-bold text-2xl text-green-600">S/ {pedido?.total}</span>
            </p>
          ...
          <div className="space-y-6">
            ...
            <button
              ...
              className="w-full p-6 border-2 border-gray-200 rounded-xl hover:border-green-500 hover:bg-green-50 transition-all flex items-center gap-4 group"
            >
              ...
              <div className="text-left">
                <div className="font-bold text-gray-800 text-lg">Pago con QR</div>
                <div className="text-gray-600">Escanea el código QR con tu app bancaria</div>
              </div>
            </button>
            ...
            <button
              ...
              className="w-full p-6 border-2 border-gray-200 rounded-xl hover:border-blue-500 hover:bg-blue-50 transition-all flex items-center gap-4 group"
            >
              ...
              <div className="text-left">
                <div className="font-bold text-gray-800 text-lg">Pago en Efectivo</div>
                <div className="text-gray-600">Paga al momento de la entrega</div>
              </div>
            </button>
          </div>
          ...
          <div className="mt-8">
            <button
              onClick={handleClose}
              className="w-full px-6 py-4 bg-gray-300 text-gray-700 rounded-xl hover:bg-gray-400 transition-colors font-semibold text-lg"
            >
              Cancelar
            </button>
          </div>
        ...
        <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl p-6 max-w-lg w-full mx-4 border border-gray-200">
          ...
          <div className="bg-gray-50 rounded-xl p-6 mb-6">
            <div className="text-center mb-4">
              ...
              <p className="text-gray-600">Referencia: Mermelada Sumaq</p>
            </div>
          ...
          <div className="flex gap-4">
            <button
              ...
              className="flex-1 px-6 py-4 bg-gray-300 text-gray-700 rounded-xl hover:bg-gray-400 transition-colors font-semibold text-lg"
              disabled={loading}
            >
              Volver
            </button>
            <button
              ...
              className="flex-1 px-6 py-4 bg-green-600 text-white rounded-xl hover:bg-green-700 transition-colors font-semibold flex items-center justify-center gap-3 text-lg"
              disabled={loading}
            >
              {loading ? (
                <>
  ...
  if (paymentMethod === 'efectivo') {
    return (
      <div className="fixed inset-0 flex items-center justify-center backdrop-blur-sm z-50">
        <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl p-8 max-w-lg w-full mx-4 border border-gray-200">
          <div className="text-center mb-8">
          ...
          <div className="bg-blue-50 rounded-xl p-8 mb-8">
            ...
            <div className="bg-white rounded-xl p-6 border border-blue-200">
              <div className="text-center">
                ...
                <p className="font-bold text-gray-800 text-xl">Pago en Efectivo</p>
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              className="flex-1 px-6 py-4 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-colors font-semibold flex items-center justify-center gap-3 text-lg"
              disabled={loading}
            >
              {loading ? (
                <>
